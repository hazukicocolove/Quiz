...
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified choice1;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified choice2;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified choice3;
- (void)viewDidLoad;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)answerWithSender:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC4Quiz13SceneDelegate")
